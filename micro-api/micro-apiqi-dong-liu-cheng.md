[https://github.com/asinglestep/micro-learn/blob/master/micro/启动流程.md](https://github.com/asinglestep/micro-learn/blob/master/micro/启动流程.md)
                            ...
                            =>//micro\go-micro\service.go
                                func (s *service) Start() error {
                                    ...
                                    if err := s.opts.Server.Start(); err != nil {
                                        =>//micro/go-micro/server/rpc_server.go
                                    ...
                                    if err := s.opts.Server.Register(); err != nil {
                                        =>//micro/go-micro/server/rpc_server.go 注册节点信息到服务发现
